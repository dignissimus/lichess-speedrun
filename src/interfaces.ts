...
const createPerf = (key: PerfKey, name: string, display: string) => ({
  key,
  name,
  display,
});

export const UltraBullet = createPerf(
  PerfKey.UltraBullet,
  "ultrabullet",
  "UltraBullet"
);
...
export const Classical = createPerf(
  PerfKey.Classical,
  "classical",
  "Classical"
);
export const Correspondence = createPerf(
  PerfKey.Correspondence,
  "correspondence",
  "Correspondence"
);
export const Standard = createPerf(PerfKey.Standard, "standard", "Standard");
export const Crazyhouse = createPerf(
  PerfKey.Crazyhouse,
  "crazyhouse",
  "Crazyhouse"
);
export const Chess960 = createPerf(PerfKey.Chess960, "chess960", "Chess960");
export const KingOfTheHill = createPerf(
  PerfKey.KingOfTheHill,
  "kingOfTheHill",
  "King of the Hill"
);
export const ThreeCheck = createPerf(
  PerfKey.ThreeCheck,
  "threeCheck",
  "Three Check"
);
export const Antichess = createPerf(
  PerfKey.Antichess,
  "antichess",
  "Antichess"
);
...
export const RacingKings = createPerf(
  PerfKey.RacingKings,
  "racingKings",
  "Racing Kings"
);
